...
FILTER_LOW = 0.5
# 带通滤波低频截止(Hz)
FILTER_HIGH = 35  # 带通滤波高频截止(Hz) - 略高于通常的30Hz以便观察
...
def main():
    ...
    # 加载数据
    file_path = r"C:\Users\clg\Desktop\测试--SW3011采集数据\50μV信号发生器--V3.csv"# 替换为您的文件路径
    raw_eeg = load_eeg_data(file_path)*1.6129032258
    ...
    # 可视化频谱
    xf, yf = show_freq(processed_eeg, SAMPLING_RATE)
    My_plot_freq(xf, yf)
