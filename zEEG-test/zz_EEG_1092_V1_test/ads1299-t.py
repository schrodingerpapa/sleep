...
def load_eeg_data(file_path):
    ...
    try:
        ...
        # eeg = eeg_data*1e6*VREF/(PGA*(2**23))
...
def main():
    ...
    # 加载数据
    file_path = r"C:\研究生\睡眠硬件--采集测试\测试数据\芯聚威测试\10Hz-10uv-x12-wulvbo.csv"
    ...
    # 可视化频谱
    xf, yf = show_freq(processed_eeg, Fs=SAMPLING_RATE)
    My_plot_freq(xf, yf)
