...
def main():
    ...
    parser.add_argument("--config", type=str, help="config file path",default="/home/chenlungan/算法模型/SleePyCo/configs/SleePyCo-Transformer_SL-01_numScales-1_Sleep-EDF-2018_pretrain.json")
