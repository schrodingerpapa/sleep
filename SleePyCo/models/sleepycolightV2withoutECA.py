...
# ==========================================================
# 1️⃣ Depthwise Separable Conv Block
# ==========================================================
...
# ==========================================================
# 2️⃣ ECA Channel Attention (轻量替代ChannelGate)
# ==========================================================
...
# ==========================================================
# 4️⃣ Lightweight SleePyCo Backbone
# ==========================================================
class Light_ECABackbone(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.layer3 = self.make_stage(72, 96, 3, pool=5)
        self.layer4 = self.make_stage(96, 128, 2, pool=5)
